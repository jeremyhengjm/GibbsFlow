...
# mcmc$parameters$stepsize <- 0.0100
# mcmc$parameters$stepsize <- 0.0075
# mcmc$parameters$stepsize <- 0.0050
# mcmc$parameters$stepsize <- 0.0025
...
gnormvelocity
save(normvelocity.df, file = "inst/variancecomponents/simulated/results/normvelocity_gfais_27.RData")
# save(normvelocity.df, file = "inst/variancecomponents/simulated/results/normvelocity_gfais_52.RData")
# save(normvelocity.df, file = "inst/variancecomponents/simulated/results/normvelocity_gfais_102.RData")
# save(normvelocity.df, file = "inst/variancecomponents/simulated/results/normvelocity_gfais_202.RData")
# save(normvelocity.df, file = "inst/variancecomponents/simulated/results/normvelocity_gfais_402.RData")
