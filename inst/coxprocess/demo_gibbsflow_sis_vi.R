...
gnormvelocity
save(normvelocity.df, file = "inst/coxprocess/results/normvelocity_gfsis_vi_400.RData")
# ggsave(filename = "~/Dropbox/GibbsFlow/draft_v3/coxprocess_normvelocity_gfsis_vi_400.pdf", plot = gnormvelocity,
